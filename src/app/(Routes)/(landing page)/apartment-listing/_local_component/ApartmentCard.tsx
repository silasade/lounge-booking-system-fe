...
function ApartmentCard({
  ...
  return (
    <div className="max-h-auto h-[776px] min-h-[776px] w-100 flex flex-col gap-2">
      <div className="w-full h-3/5 grid grid-cols-2 grid-row-2 gap-y-4 gap-x-4">
      ...
      <div className="w-full flex flex-col row-gap-4 md:flex-row justify-between items-start">
        <div className="flex flex-col gap-3 md:gap-5 w-100 md:w-2/4">
        ...
        <div className="w-full md:w-2/4">
          <button className="bg-primary h-[40px] md:h-[50px] text-[18px] w-full md:w-auto p-5 text-center flex justify-center items-center font-[500] rounded-lg text-white">
            Select Apartment
          </button>
