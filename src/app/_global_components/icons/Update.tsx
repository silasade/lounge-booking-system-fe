...
export default function SmartphoneUpdateOutline(props: SVGProps<SVGSVGElement>) {
    return (
      <svg
      ...
      >
        <g fill="none">
          <g clipPath="url(#solarSmartphoneUpdateOutline0)">
            <path
              fill="currentColor"
              fillRule="evenodd"
          ...
          <defs>
            <clipPath id="solarSmartphoneUpdateOutline0">
