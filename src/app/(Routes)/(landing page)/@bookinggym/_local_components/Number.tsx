...
function Number() {
  const { setGymPaymentDetails } = useGymPayment();
  ...
  const handlePeopleChange = useCallback(
    (value: number) => {
      ...
      setGymPaymentDetails((prev) => ({ ...prev, noOfPeople: value }));
    },
    [setGymPaymentDetails]
  );

  const handleHoursChange = useCallback(
    (value: number) => {
      setNumber((prev) => ({ ...prev, noOfHours: value }));
      setGymPaymentDetails((prev) => ({ ...prev, noOfHours: value }));
    },
    [setGymPaymentDetails]
  );
  ...
  const handleDaysChange = useCallback(
    (value: number) => {
      ...
      setGymPaymentDetails((prev) => ({ ...prev, noOfDays: value }));
    },
    [setGymPaymentDetails]
  );
