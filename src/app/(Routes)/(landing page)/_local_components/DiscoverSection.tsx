...
function DiscoverSection() {
  return (
    <div className="flex flex-row items-center gap-20 p-20 pl-30 pr-30 border-bottom border-borderColor">
      <div className="w-2/5 flex flex-col gap-6">
        <h3 className="text-secondary font-[700] text-[25px] leading-[29px]">
      ...
      <div className="grid grid-cols-2 grid-row-2 w-3/5 h-[350px] gap-y-1 gap-x-1">
        <motion.div
