...
function Number() {
  ...
  const handlePeopleChange = useCallback((value: number) => {
  ...
  return (
    <div className="flex flex-col gap-6 border-b border-[#B3B3B3] p-4">
      <div className="flex flex-row justify-between items-center">
        <div className="flex flex-col gap-3">
          <h5 className="text-[20px] font-[500]">Number of People</h5>
      ...
      <div className="flex flex-row justify-between items-center">
        <div className="flex flex-col gap-3">
          <h5 className="text-[20px] font-[500]">Number of Hours</h5>
          <p className="italic text-[#4A4A4A] text-[16px] font-[300]">
            How many hours?
          </p>
        </div>
      ...
      <div className="flex flex-row justify-between items-center">
        <div className="flex flex-col gap-3">
          <h5 className="text-[20px] font-[500]">Number of Days</h5>
          <p className="italic text-[#4A4A4A] text-[16px] font-[300]">
            How many days?
          </p>
        </div>
